...
{	
	...
	{
		player.addChatComponentMessage(new ChatComponentText(EnumChatFormatting.AQUA + "[Pet Rock] " + EnumChatFormatting.WHITE + StatCollector.translateToLocal("Chat." + UnlocalizedName)));
	}

	public static void ChatMessageString(String string)
	{
		player.addChatComponentMessage(new ChatComponentText(EnumChatFormatting.AQUA + "[Pet Rock] " + EnumChatFormatting.WHITE + string));
	}
